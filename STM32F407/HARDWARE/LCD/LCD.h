...
#define SET_LCD_SDA GPIO_SetBits(GPIOE,GPIO_Pin_7)     //  PF2  数据位
#define CLR_LCD_SDA GPIO_ResetBits(GPIOE,GPIO_Pin_7)

#define SET_LCD_SCL GPIO_SetBits(GPIOE,GPIO_Pin_8)     //  PF3  数据位
#define CLR_LCD_SCL GPIO_ResetBits(GPIOE,GPIO_Pin_8)
